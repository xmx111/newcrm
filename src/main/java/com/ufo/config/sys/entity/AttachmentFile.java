...
@Entity
@Table(name = "tb_sys_attachment_file")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@JsonAutoDetect(fieldVisibility = Visibility.NONE, getterVisibility = Visibility.NONE, isGetterVisibility = Visibility.NONE)
public class AttachmentFile extends PersistableEntity<String> {

    private static final long serialVersionUID = 3228982392355348971L;
    /** 附件上传文件名称 */
    ...
    @Transient
    @JsonIgnore
    public static AttachmentFile buildInstance(MultipartFile file) {
...
//        sb.append("/" + StringUtils.substring(id, 0, 2));
        ...
        af.setFileLength((int) file.getSize());
        return af;
    }
